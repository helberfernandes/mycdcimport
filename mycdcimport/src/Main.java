	...
	public static void main(String[] args) {
		...
		for (Livro livro : livros) {
			...
			for (Parte parte : livro.getPartes()) {
				...
				//	System.out.println("|......" + seccao.getDescricao());
				}
			}
			...
			while (s != null) {
				...
				if (s != null) {
					...
					//
						...
						// System.out.println("------------"+canone.getLivro().getTitulo()+"------------"+canone.getDescricao());
						//fimCan = false;
					...
					} else if (s.contains("PARTE") && s.contains("-")) {
